...
# tool to automatically alternate between vertical and horizontal mode
...
bindsym $mod+n exec i3-sensible-terminal -e nvim
bindsym $mod+y exec i3-sensible-terminal -e yazi
bindsym $mod+d exec rofi -show drun
bindsym Print exec xfce4-screenshooter
bindsym control+mod1+l exec xflock4
